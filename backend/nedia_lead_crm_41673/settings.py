"""
Django settings for nedia_lead_crm_41673 project.
...
ROOT_URLCONF = 'nedia_lead_crm_41673.urls'
...
WSGI_APPLICATION = 'nedia_lead_crm_41673.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "nedia_lead_crm_41673 API",
    "DESCRIPTION": "API documentation for nedia_lead_crm_41673 App",
    "VERSION": "v1",
}
